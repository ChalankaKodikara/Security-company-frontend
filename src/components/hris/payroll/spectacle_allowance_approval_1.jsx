...
const SpectacleAllowanceApproval1 = () => {
    ...
    const handleApproveLevel1 = async () => {
        ...
        try {
            ...
            toast.success(resJson.message || "Approved successfully");
    ...
    const handleRejectLevel1 = async () => {
        ...
        try {
            ...
            const resJson = await res.json();
            toast.success(resJson.message || "Rejected successfully");
    ...
    const fetchClaims = async () => {
        try {
            ...
            if (employeeNo) queryStr.append("employee_no", employeeNo);

            const res = await apiFetch(
                `${API_URL}/v1/hris/claims/?${queryStr.toString()}`,
                {
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const downloadClaimDocument = async (employeeNo, documentPath) => {
        try {
            ...
            const res = await apiFetch(
                `${API_URL}/v1/hris/download/download/claim-document?${queryStr.toString()}`,
                {
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${token}`,
            ...
            // Extract filename (fallback safe)
            const fileName =
                documentPath.split("/").pop() || "claim-document";
...
export default SpectacleAllowanceApproval1;
