...
const MedicalAllowanceApproval2 = () => {
    ...
    return (
        ...
        text-white text-sm font-bold shadow-lg bg-gradient-to-br ${avatarBgClass(
            ...
            <Modal
                ...
                className="bg-white rounded-2xl shadow-xl max-w-md mx-auto mt-40 p-6 outline-none"
...
export default MedicalAllowanceApproval2;
