...
export default function View_Genarate_Month_End_Payroll() {
  ...
  console.log("View_Genarate_Month_End_Payroll Component Rendered");
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const res = await apiFetch(
        `${API_URL}/v1/hris/payroll/generate/ho`,
        {
          method: "POST",
          credentials: "include",
