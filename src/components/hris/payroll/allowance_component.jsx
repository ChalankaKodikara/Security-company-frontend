...
const AllowanceComponent = () => {
  ...
  // Function to fetch all employee data with pagination and filters
  const fetchEmployeeData = async () => {
    ...
    try {
      ...
      const response = await apiFetch(
        `${API_URL}/v1/hris/payroll/allowance-status?${params.toString()}`,
        {
          credentials: "include",
        }
      );
  ...
  const handleUpdate = async () => {
    try {
      ...
      setPopupMessage("Allowance updated successfully!"); // Added success message
      setPopupType("success");
      setShowPopupMessage(true);
      ...
      setPopupMessage("Failed to update allowance. Please try again."); // Added error message
      setPopupType("error");
      setShowPopupMessage(true);
    } finally {
      setIsSaving(false);
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      setPopupMessage("Allowance removed successfully!"); // Added success message
      setPopupType("success");
      setShowPopupMessage(true);
      ...
      setPopupMessage("Failed to remove allowance. Please try again."); // Added error message
      setPopupType("error");
      setShowPopupMessage(true);
    } finally {
      setIsSaving(false);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await apiFetch(
        `${API_URL}/v1/hris/payroll/allowances/bulk-upload`,
        {
          method: "POST",
  ...
  const handleDownloadSample = () => {
    ...
    link.href = url;
    link.download = "sample_allowance_upload.csv";
    link.click();
          ...
          <div className="mt-6 ml-10">
            ...
            >
              ...
              <p className="text-center text-sm text-gray-700">
                <span className="font-semibold">Drag & drop</span> your CSV
                here, or{" "}
