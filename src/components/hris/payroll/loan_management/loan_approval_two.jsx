...
const LoanApplicationsWithOrgFilter = () => {
    ...
    const loadLoans = async () => {
      ...
      try {
        const params = new URLSearchParams({
          ...
          approval_status_2: "PENDING", //  LEVEL 2
          page: currentPage,
          limit: rowsPerPage,
        });
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Please log in to view loan applications.
          </p>
        </div>
      </div>
    );
  ...
  const handleReject = async () => {
    ...
    try {
      const res = await apiFetch(
        `${API_URL}/v1/hris/loans/reject-level-2`,
  ...
  const handleApprove = async () => {
    ...
    setActionLoading(true);
    try {
      const res = await apiFetch(`${API_URL}/v1/hris/loans/approve-level-2`, {
        method: "POST",
      ...
      {showActionModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          ...
          >
            ...
            <h2 className="text-xl font-bold mb-4">Loan Action</h2>
