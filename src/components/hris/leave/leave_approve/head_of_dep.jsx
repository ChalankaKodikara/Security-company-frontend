      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full ">
        ...
        <form className="">
          ...
          <div className="flex gap-6 mt-6 items-center justify-between">
            ...
            {/* right content */}
            <div className="flex">
              <button className="text-white bg-black font-[12px] py-2 px-4 border border-purple-600 rounded-md shadow-sm hover:bg-purple-600 hover:text-white transition duration-300">
          ...
          <div className="flex gap-6 mt-6 items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-6">
                <div className="flex">
                  <button className="text-white bg-primary_purple  font-[12px] py-4 px-2 border border-purple-600 rounded-md shadow-sm hover:bg-purple-600 hover:text-white transition duration-300">
